...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.timeOnly = options.timeOnly == null ? false : options.timeOnly;
	...
	Datetimepicker.prototype = {
		...
		hide: function(e){
			...
			this.picker.hide();
			this.element.find('input:first').trigger('datetime-changed');
		...
		fill: function() {
			...
			var d = new Date(this.viewDate),
				...
				if (this.timeOnly){
					this.picker.find('thead').hide();
					this.picker.find('tfoot').hide();
					this.picker.find('table').width("100%");
				}
