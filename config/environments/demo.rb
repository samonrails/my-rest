...
SnapPea::Application.configure do
  config.catering_subdomain = "catering-demo"
...
#  config.force_ssl = true
  ...
  config.action_mailer.default_url_options = { :host => 'snappea-demo.fooda.com' }
  ...
  config.action_mailer.smtp_settings = {
    ...
    :user_name => "mailtrap-snappea-demo-06b5288fd695bf8e",
    :password => "82506f6ce9890c5d"
  }
end
