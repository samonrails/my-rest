...
SnapPea::Application.configure do
  config.catering_subdomain = "catering-staging"
...
#  config.force_ssl = true
  ...
  config.action_mailer.default_url_options = { :host => 'snappea-staging.fooda.com' }
  ...
  config.action_mailer.smtp_settings = {
    ...
    :user_name => "mailtrap-snappea-staging-ebe4be56e58eeaea",
    :password => "71edccfbad4c7ada"
  }
end
